    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-teal-50 to-teal-100 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8 bg-white p-10 rounded-xl shadow-lg animate-fade-in-up"> 
        ...
        <form className="mt-8 space-y-6" onSubmit={handleRegister}>
          ...
          <div className="rounded-md shadow-sm flex flex-col gap-4"> 
            ...
            <div className="transform transition duration-300 hover:translate-y-[-2px]">
              ...
              />
              <p className="mt-1 text-xs text-gray-500">Example: user@example.com</p>
            </div>
            <div className="transform transition duration-300 hover:translate-y-[-2px]">
              ...
              />
              <div className="mt-1 text-xs text-gray-600 text-left">
                <p>Password must:</p>
                <ul className="list-disc ml-5">
                  <li className={password.length >= 8 ? "text-teal-600 font-medium" : ""}>Be at least 8 characters long</li>
                  <li className={/\d/.test(password) ? "text-teal-600 font-medium" : ""}>Contain at least one number</li>
                  <li className={/[!@#$%^&*(),.?":{}|<>]/.test(password) ? "text-teal-600 font-medium" : ""}>
        ...
        <div className="text-sm text-center mt-4">
          ...
          <Link to="/login" className="font-medium text-teal-600 hover:text-teal-500 transition duration-300 ease-in-out">
            Sign in
          </Link>
        </div>
      </div>
